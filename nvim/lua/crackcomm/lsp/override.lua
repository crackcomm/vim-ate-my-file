...
local custom_attach = function(client, bufnr)
  ...
  buf_nnoremap({ "<space>cl", RX("crackcomm.lsp.actions.lint").suppress_diagnostic(), "lsp:suppress_diagnostic" })
  ...
  buf_nnoremap({ "<space>cf", RX("crackcomm.lsp.actions.fix_all").fix_all(), "lsp:fix_all" })
